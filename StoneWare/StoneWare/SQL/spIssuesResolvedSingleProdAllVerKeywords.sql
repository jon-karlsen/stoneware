...
-- Description:	This stored procedure returns all issues with status set to “resolved” for a single product of all versions and containing a list of keywords (passed to the procedure as a string of comma-separated values).
-- =============================================
